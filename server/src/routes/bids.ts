...
const INDUSTRY_CLASSIFICATIONS: Record<string, { keywords: string[]; label: string }> = {
  // 1. 环境与监测 - 优先匹配，因为容易被误分到IT
  '环境监测': {
    keywords: ['环境', '监测', '检测', '污染', '土壤', '水质', '空气', '废气', '废水', '固废', '危废', '辐射', '噪声', '生态', '绿化', '环卫', '垃圾', '填埋', '渗滤液', '除臭', '除尘', '减排', '碳排放', '环评', '竣工验收', '应急预案', '风险评估', '环境治理'],
    label: '环境监测'
  },
  // 2. 医疗健康
  '医疗健康': {
    keywords: ['医疗', '医院', '药品', '医药', '器械', '保健', '防疫', '疫苗', '诊疗', '病床', '监护', '影像', '超声', '检验', '体检', '中医', '西医', '药店', '血站', '疾控', '卫生', '康复', '养老', '殡葬'],
    label: '医疗健康'
  },
  // 3. 教育培训
  '教育培训': {
    keywords: ['教育', '学校', '培训', '教学', '课程', '教材', '课桌椅', '实验室', '实训', '教室', '幼儿园', '中小学', '大学', '学院', '体测', '体育', '运动', '操场', '跑道', '篮球', '足球', '排球', '羽毛球', '乒乓球', '游泳'],
    label: '教育培训'
  },
  // 4. IT服务 - 必须是纯IT相关，减少误匹配
  'IT服务': {
    keywords: ['计算机', '软件', '系统集成', 'IT', '信息安全', '服务器', '数据库', '云计算', '大数据', '人工智能', '软件开发', '网络设备', '交换机', '路由器', '存储设备', '机房', '运维', '信息安全', '网络安全', '等级保护'],
    label: 'IT服务'
  },
  // 5. 建筑工程
  '建筑工程': {
    keywords: ['建筑', '装修', '装饰', '工程', '施工', '监理', '设计', '勘察', '造价', '市政', '道路', '桥梁', '隧道', '钢结构', '消防', '电梯', '空调', '门窗', '防水', '保温', '幕墙', '园林', '景观', '亮化', '照明', '管线', '管网', '基础设施'],
    label: '建筑工程'
  },
  // 6. 物业服务
  '物业服务': {
    keywords: ['物业', '保洁', '保安', '绿化', '停车', '后勤', '食堂', '餐饮', '厨余', '公寓', '宿舍', '保洁服务', '保安服务', '物业服务'],
    label: '物业服务'
  },
  // 7. 车辆设备
  '车辆设备': {
    keywords: ['车辆', '汽车', '客车', '货车', '特种车', '救护车', '消防车', '环卫车', '校车', '班车', '出租车', '新能源汽车', '电动车', '充电桩', '车辆采购', '汽车采购'],
    label: '车辆设备'
  },
  // 8. 办公家具
  '办公家具': {
    keywords: ['家具', '办公桌', '椅子', '柜子', '书架', '会议桌', '沙发', '课桌椅', '实验室家具', '学校家具', '办公家具', '密集架', '档案柜'],
    label: '办公家具'
  },
  // 9. 食材配送
  '食材配送': {
    keywords: ['食材', '蔬菜', '肉类', '粮油', '副食品', '食品', '农产品', '生鲜', '水果', '牛奶', '饮料', '食品采购', '食材采购', '食堂采购'],
    label: '食材配送'
  },
  // 10. 印刷服务
  '印刷服务': {
    keywords: ['印刷', '纸张', '文具', '办公用品', '硒鼓', '墨盒', '打印', '复印', '制版', '宣传品', '画册', '包装', '标牌', '横幅', '展板'],
    label: '印刷服务'
  },
  // 11. 水利工程
  '水利工程': {
    keywords: ['水利', '水务', '灌溉', '防洪', '防汛', '除险加固', '堤防', '水库', '大坝', '河道', '清淤', '蓄水', '饮水', '供水', '排水', '污水处理', '自来水'],
    label: '水利工程'
  },
  // 12. 电力能源
  '电力能源': {
    keywords: ['电力', '电网', '供电', '配电', '变电', '输电', '用电', '发电', '光伏', '风电', '太阳能', '新能源', '储能', '充电桩', '换电站'],
    label: '电力能源'
  },
  // 13. 广播电视
  '广播电视': {
    keywords: ['广播', '电视', '传媒', '宣传', '文化', '文物', '旅游', '景区', '公园', '场馆', '图书馆', '博物馆', '文化馆', '剧院', '电影院'],
    label: '广播电视'
  },
  // 14. 司法法律
  '司法法律': {
    keywords: ['法律', '律师', '司法', '公证', '鉴定', '仲裁', '调解', '法律援助', '法制'],
    label: '司法法律'
  }
};
